...
用法:
    python load_test.py --url http://127.0.0.1:8001 --key <访问密钥> --traffic 10
...
def main():
    ...
    parser.add_argument("--url", default="http://127.0.0.1:8001", help="服务地址（SSH 端口转发后默认 http://127.0.0.1:8001）")
